# This is a compatibility shim for upgrading from turbolinks 2.5.
# Taken from https://github.com/turbolinks/turbolinks/blob/master/src/turbolinks/compatibility.coffee
